# Sessão 19/ago — Analytics + Anúncios

## Google Analytics Instalado
- **Measurement ID:** G-YXNPQDS5EB
- **Arquivo:** index.html (cabeçalho)
- **Status:** Publicado e ativo
- **Dados aparecem em:** 24-48h em analytics.google.com

## Configurações feitas no Google Analytics
- **Conta:** Lucas Designer Web
- **Propriedade:** lucasdesignerweb.com.br
- **Categoria:** Computers & Electronics
...
- 2 versões de anúncio Google Ads
- 3 versões de post Meta Ads
- 3 posts orgânicos Instagram
- 3 textos Stories/Reels
